...
export const FEDERATED_HTTP_ROUTES = [
  ...
  { method: "GET", path: "/projects/:projectId/workspaces/:workspaceId/git/log" },
  { method: "POST", path: "/projects/:projectId/workspaces/:workspaceId/git/stage" },
  { method: "POST", path: "/projects/:projectId/workspaces/:workspaceId/git/unstage" },
  { method: "POST", path: "/projects/:projectId/workspaces/:workspaceId/git/commit" },
  { method: "POST", path: "/projects/:projectId/workspaces/:workspaceId/git/pull" },
  { method: "POST", path: "/projects/:projectId/workspaces/:workspaceId/git/push" },
  { method: "POST", path: "/projects/:projectId/workspaces/:workspaceId/git/fetch-all" },
